...
OSM_PATH = "honolulu_sample2.osm"

NODES_PATH = "hawaii_nodes_f4.csv"
NODE_TAGS_PATH = "hawaii_nodes_tags_f4.csv"
WAYS_PATH = "hawaii_ways_f4.csv"
WAY_NODES_PATH = "hawaii_ways_nodes_f4.csv"
WAY_TAGS_PATH = "hawaii_ways_tags_f4.csv"
...
def build_node_tag(node_id, key_k, value_v, tag_type):
  ...
  if(LOWER_COLON.search(tag_type)):   
    ...
    if(addr_street_check == "addr:street"):
      return_dict['value'] = audit_f.update_name(value_v, audit_f.mapping)      

    elif(addr_street_check == "addr:postcode"):
      return_dict['value'] = audit_zip.update_zip(value_v)
